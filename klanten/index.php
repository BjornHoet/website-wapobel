<?php
$prefix = '../';
$activeKlanten = 'active';

include $prefix.'/bin/init.php';
$pageTitle = 'Billit klanten';
...
//$clients = getClients('');
$dataFile = $wateringData['wateringId'] . '_clients.json';
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="card-body">
                                    <div class="p-3 mb-2 bg-light rounded border">
										<div class="d-flex align-items-center">
											...
											<h6 class="font-weight-bold mb-0 text-dark">Overzicht van je Billit klanten</h6>
										</div>
									</div>
