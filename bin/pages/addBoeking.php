...
$boeking = addBoeking($wateringId, $wateringJaar, $maand, $dag, $postId, $subpostId, $omschrijving, $nummering, '');

$rekeningen = getRekeningen($wateringData['wateringId'], $wateringJaar, 'X', '', 'A');
foreach($rekeningen as $rekening) {
	addBoekingRek($boeking, $rekening['rekeningId'], 'O');
	addBoekingRek($boeking, $rekening['rekeningId'], 'U');
	}
