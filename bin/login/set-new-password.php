                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-2">Wachtwoord instellen</h1>
									</div>
									<p class="mt-4"></p>
									<?php if ($error !== '') { ?>
									...
									<?php } else { ?>
										<form class="user" action="changepassword.php" method="post" role="form" onsubmit="return validation()">
											<div class="form-group">
												...
												<div class="password-wrapper">
													<input type="password" name="userPassword" class="form-control form-control-user" id="inputPasswordLogin" placeholder="Wachtwoord" required>
													<span toggle="#inputPasswordLogin" class="fa fa-fw fa-eye field-icon toggle-password" style="display: none;"></span>
												</div>
											</div>
											<div class="password-wrapper">
												<input type="password" name="checkUserPassword" class="form-control form-control-user" id="inputCheckPassword" placeholder="Herhaal wachtwoord" onChange="validation();" required>
											...
											<div class="text-center">
												<input class="btn btn-primary btn-user px-5" type="submit" value="Wachtwoord instellen" id="profileSubmit" disabled>
											</div>
										</form>
									<?php } ?>
                                    <hr>
